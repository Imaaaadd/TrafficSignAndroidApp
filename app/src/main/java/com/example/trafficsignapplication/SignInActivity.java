...
import com.example.trafficsignapplication.helpers.StringHelper;
...
public class SignInActivity extends AppCompatActivity {
    ...
    public void authenticateUser() {
        ...
        String url = "http://192.168.43.5:9080/api/user/login";
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            Intent goToCamera = new Intent(SignInActivity.this, HomeActivity.class);
